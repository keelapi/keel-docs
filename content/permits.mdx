...
Start here for a first permit call. Add estimates, routing, or `context` only when your policy needs them.

Keep `idempotency_key` even though it is optional in the schema. It is the smallest safe starting point for retries.

```json
{
  "project_id": "<project_uuid>",
  "idempotency_key": "permit-min-001",
  "subject": {
    "type": "user",
    "id": "usr_123"
  },
