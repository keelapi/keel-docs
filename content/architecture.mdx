...
See [Platform Surfaces](/platform-surfaces) for the mounted route matrix and [Execution Spine](/execution-spine) for the shared stage machinery.
...
The full doctrine lives on [Beta Scope](/beta-scope).
